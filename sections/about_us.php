<section class="about-us" id="aboutus">
	<div class="container">
		...
		<div class="section-header">
			...
			if ( ! empty( $zerif_aboutus_subtitle ) ) {
				...
				echo esc_html__( $zerif_aboutus_subtitle, 'zerif-lite' );
				echo '</h6>';
			}
			?>
		...
		<div class="row">
			...
			if ( ! empty( $zerif_aboutus_biglefttitle ) ) {
				...
				echo esc_html__( $zerif_aboutus_biglefttitle, 'zerif-lite' );
				echo '</div>';
				echo '</div>';
			}
			...
			if ( ! empty( $zerif_aboutus_text ) ) {
				...
				echo '<p>';
				echo esc_html__( $zerif_aboutus_text, 'zerif-lite' );
				echo '</p>';
				echo '</div>';
			}
			?>
	...
	if ( is_active_sidebar( 'sidebar-aboutus' ) ) {
		...
		echo '<div class="our-clients">';
			...
			echo '<h5><span class="section-footer-title">' . __( 'naši klienti', 'zerif-lite' ) . '</span></h5>';
